...
<form name="f1">  
<div class="row">  
    <img src="images/web1 (2).png" width="700px" height="300px" class="responsive mb-2">
...
<div class="row align-items-center justify-content-center mb-5">
  <div class="col-md-6">
    ...
    <img src="images/1.png" class="d-md-block" height="150px" weight="150px" />
        <div class="card-body">
  ...
  <div class="col-md-3">
    <div class="card" style="width: 13rem ;background-color:#87CEFA">
    <img src="images/2.png" class="d-md-block" height="150px" weight="150px" />
        <div class="card-body">
